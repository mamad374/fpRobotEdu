                                    ...
                                    <th>Action</th>
                                      ...
                                      <?php foreach ($data as $d) { ?>
                                        <tr>
                                            ...
                                            <td >       
                                              <a class="btn btn-success" href="<?php echo base_url()."index.php/BackLayar/editData/".$d['Id_artikel']; ?>">Edit</a> || 
                                              <a class="btn btn-danger" href="<?php echo base_url()."index.php/BackLayar/doDelete/".$d['Id_artikel']; ?>">Delete</a> 
                                            </td>      
                                        </tr>
                                      <?php } ?>
