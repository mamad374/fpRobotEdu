            ...
            <div class="container-fluid">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" action="<?php echo base_url()."index.php/BackLayar/doUpdate"; ?>" enctype="multipart/form-data">
								<table class="table">
                                     <tr>
                                         <td><label>Id Artikel</label></td>
                                        <td>: </td>
                                        <td><input type="text" class="form-control border-input" name="Id_artikel" value="<?php echo $Id_artikel ;?>"></td>
                                     </tr>  
									 <tr>
										<td><label>Judul</label></td>
										<td>: </td>
										<td><input type="text" class="form-control border-input" name="Judul" value="<?php echo $Judul ;?>"></td>
									 </tr>									 
									 <tr>
